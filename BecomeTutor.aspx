<%@ Page Title="Become a Tutor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BecomeTutor.aspx.cs" Inherits="TutorBookings.BecomeTutor" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
            <div class="Main">
                <h3>Want to become a tutor? We're hiring students!</h3>
                <p>Requirements:</p>
                <ul>
                    <li>A current student at our institution</li>
